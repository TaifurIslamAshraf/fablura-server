...
//chart
orderRoute.get("/monthly-sales", authGard_1.isAuthenticated, (0, authGard_1.authorizeUser)("admin"), order_controller_1.getSealesReport);
orderRoute.get("/order-status", authGard_1.isAuthenticated, (0, authGard_1.authorizeUser)("admin"), order_controller_1.getOrderStatus);
